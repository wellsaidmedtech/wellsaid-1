...
HUME_EVI_WS_URL = os.getenv("HUME_EVI_WS_URL")
...
# temp reversion - WebSocket Connection Management
active_connections = {}
...
class EviHandler:
    ...
    """
    def __init__(self, twilio_ws: WebSocket, hume_socket: WebSocket, call_sid: str, transcript_list: list):
        ...
        try:
            while True:
                ...
                if message_json['event'] == 'media':
                    ...
                    await self.hume_socket.connect(hume_access_url)
